...
const socials = [
  ...
  {
    icon: faGithub,
    url: "https://github.com/tomfenoglio",
  },
  {
    icon: faLinkedin,
    url: "https://www.linkedin.com/in/tomas-fenoglio-44279676/",
  },
  {
    icon: faMedium,
...
const Header = () => { 
  ...
  useEffect(() => { 
    ...
    // It’s important to remove all subscriptions before the unmounting phase
    return () => { 
      window.removeEventListener('scroll', handleScroll) 
    } 
  }, []); 

  // this functions slides to corresponding section
      ...
      <Box color="white" maxWidth="1280px" margin="0 auto">
        ...
        >
          <nav>
            ...
            <HStack gap={4}>
              {socials.map((social) => (
                <a href={social.url} key={social.url} target="_blank">  {/* picking as key their URL, which is unique per item */}
